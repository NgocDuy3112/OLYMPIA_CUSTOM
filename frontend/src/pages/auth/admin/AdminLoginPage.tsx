...
const AdminLoginPage: React.FC = () => {
    ...
    return (
        <BaseAuthLayout title="OLYMPIA CUSTOM 3" subtitle="Đăng nhập quản trị">
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <a href="/admin/signup" className="text-center text-sm text-white underline opacity-80 hover:opacity-100">Tạo tài khoản admin</a>
            </form>
        </BaseAuthLayout>
    );
};
